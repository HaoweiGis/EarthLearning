...
# encoding_repo_url = 'https://download.pytorch.org/models'
...
def get_resnet_file(name, root='~/.torch/models'):
    ...
    # file_name = '{name}-{short_hash}'.format(name=name, short_hash='19c8e357')
    ...
    # return os.path.join(root, name + '.pth')


def get_model_file(name, root=r'base_models'):
    # root = os.path.expanduser(root)
